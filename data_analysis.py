...
top_protein = df.sort_values('Protein(g)', ascending=False).groupby('Diet_type').head(5).sort_values(['Diet_type', 'Protein(g)'], ascending=[True, False])
...
#Heatmap showing the relationship between macronutrient and diet types
